...
public class TimeOnlyConverterTests
{
    ...
    public void ConvertToStringTest()
    {
        ...
        Assert.That(TimeOnlyConverter.Convert(tOnly, TimeStampPrecision.Second), Is.EqualTo("13:30:45"));
        Assert.That(TimeOnlyConverter.Convert(tOnly, TimeStampPrecision.Millisecond), Is.EqualTo("13:30:45.999"));
        Assert.That(TimeOnlyConverter.Convert(tOnly, TimeStampPrecision.Microsecond), Is.EqualTo("13:30:45.999050"));
        Assert.That(TimeOnlyConverter.Convert(tOnly, TimeStampPrecision.Nanosecond), Is.EqualTo("13:30:45.999050000"));
    }
}
